 ...
 */
export async function bindManual(store, { appId, appSecret, domain = "feishu" }, { verifyApp = verifyFeishuApp } = {}) {
...
export function createBind(home, hooks = {}) {
  ...
  return {
    store,
    bindManual: (input, extra = {}) => bindManual(store, input, { ...hooks, ...extra }),
